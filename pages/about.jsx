          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12 text-center">
                <div className="text-wrapper">
                  <div className="sub-heading">
                    Health Tips, News and Events
                  </div>
                  <h3 className="heading mb-5">From the Blog</h3>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="owl-carousel">
                  <article className="reviewWrapper">
                    <div className="image">
                      <img src="../media/taking-blood.png" alt="" />
                    </div>
                    <div className="details">
                      ...
                      <p className="testimonial">
                        ...
                        elit. Eveniet dolorum recusandae cumque eum rem ipsa
                        similique, omnis quisquam mollitia obcaecati!
                      </p>
                    </div>

                    <strong className="by d-flex">
                      <div className="date">June 21, 2020</div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12 text-center">
                <div className="text-wrapper">
                  <div className="sub-heading">
                    100s of Laboratories are already partnered with us
                  </div>
                  <h3 className="heading mb-5">Register your Laboratory</h3>
                </div>
              </div>
            </div>
            ...
            <div className="row reviewactionrow py-4">
              ...
              <div className="col-sm-6 col-2 d-flex justify-content-end">
                <div className="buttons d-flex">
                  <button type="button" className="btn btn_left">
                    <img src="../media/right.svg" alt="" />
                  </button>
